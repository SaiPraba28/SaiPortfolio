...
import { FaEnvelope, FaPhone, FaGraduationCap, FaInstagram, FaWhatsapp, FaTwitter, FaYoutube, FaUser, FaFacebook, FaGithub, FaLinkedin } from "react-icons/fa";
  ...
  const contacts = [
    {
      ...
      label: "Email",
      value: "saipraba28@gmail.com",
    },
    {
      icon: <FaEnvelope className="w-5 h-5" />,
      label: "Alternate Email",
      value: "saiprabar28@gmail.com",
    },
    {
    ...
    },
    {
      ...
      label: "Education",
      value: "B.E in Computer Science and Engineering",
    },
  ];
  ...
  const socials = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/SaiPraba28",
    },
    {
      icon: <FaLinkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/sai-praba-r/",
    },
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          <a
            href="mailto:saipraba28@gmail.com"
